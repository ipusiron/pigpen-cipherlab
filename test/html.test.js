...
test('decode stores symbols and resolves their original images', () => {
  assert.match(script, /PigpenCore\.glyphSource\(shape\)/);
  assert.match(script, /PigpenCore\.decodeSequence\(state\.decodeItems, state\.variant\)/);
